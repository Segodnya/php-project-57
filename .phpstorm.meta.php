...
'main','task_statuses.index','task_statuses.create','task_statuses.store','task_statuses.show',
'task_statuses.edit','task_statuses.update','task_statuses.destroy','labels.index','labels.create',
...
'tasks.update','tasks.destroy','register','login','password.request','password.email','password.reset','password.store',
