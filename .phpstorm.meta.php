...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/segodnya/Desktop/hexlet/php-project-57/public/storage' => 'string',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/segodnya/Desktop/hexlet/php-project-57/public/storage',
...
'sanctum.migrations','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
...
'concurrency.default','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddQueries.maximum_number_of_collected_queries',
...
'query-builder.convert_relation_names_to_snake_case_plural','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'main','task_statuses.index','labels.index','tasks.index','tasks.create',
'tasks.show','task_statuses.create','task_statuses.store','task_statuses.edit','task_statuses.update',
'task_statuses.destroy','labels.create','labels.store','labels.edit','labels.update',
'labels.destroy','tasks.store','tasks.edit','tasks.update','tasks.destroy',
...
'auth.verify-email','components.application-logo','components.auth-session-status','components.base-layout','components.button-form',
'components.card','components.form-container','components.form-field','components.form-wrapper','components.form.input',
'components.form.select','components.form.textarea','components.guest-layout','components.head-task-manager','components.hexlet-stub-test',
'components.input-error','components.input-label','components.nav-task-manager','components.page-header','components.primary-button',
'components.responsive-nav-link','components.table','components.task-status','components.task-status-badge','components.text-input',
'components.title-task-manager','label.create','label.edit','label.index','layouts.app',
'layouts.guest','layouts.main','main','status.create','status.edit',
'status.index','task.create','task.edit','task.index','task.show',
...
'validation.uuid','validation.custom.attribute-name.rule-name','messages.Password','messages.Remember me','messages.Email',
'messages.Login','messages.The email has already been taken.','messages.The password field confirmation does not match.','messages.The password field must be at least 8 characters.','messages.Log in',
'messages.Log Out','messages.Task Manager','messages.Task','messages.Statuses','messages.Status',
'messages.Label','messages.Forgot your password?','messages.Name','messages.Already registered?','messages.Confirm Password',
'messages.Register','messages.Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.','messages.Confirm','messages.This is a secure area of the application. Please confirm your password before continuing.','messages.Email Password Reset Link',
'messages.Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.','messages.A new verification link has been sent to the email address you provided during registration.','messages.Resend Verification Email','messages.Author','messages.Executor',
'messages.To change','messages.Edit','messages.Delete','messages.No','messages.Yes',
'messages.Create status','messages.Create label','messages.Create task','messages.Create','messages.Apply',
'messages.Confirm the action on the page','messages.Are you sure you want to delete the tasks','messages.Cancel','messages.Create a task','messages.Title',
'messages.Description','messages.Changing the task','messages.Are you sure you want to delete the status','messages.Changing the status','messages.Create a status',
'messages.Are you sure you want to delete the label','messages.Changing the label','messages.Create a label','messages.Registration','messages.The task has been successfully updated',
