...
<?php endif; ?>
                ...
                <textarea name="description" id="description" class="form-control" style="height: 21.25rem;"><?php echo e(old('description')); ?></textarea>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-3">
                <a class="btn btn-secondary" href="<?php echo e(route('labels.index')); ?>"><?php echo e(__('messages.Cancel')); ?></a>
                <button type="submit" class="btn btn-primary mx-1.5"><?php echo e(__('messages.Create')); ?></button>
            </div>
        </div>
    </form>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.title-task-manager','data' => ['text' => 'messages.Create a label']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/segodnya/Desktop/hexlet/php-project-57/resources/views/label/create.blade.php ENDPATH**/ ?>