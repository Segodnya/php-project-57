...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['hover' => true,'class' => 'm-2.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    <div class="col-3 d-flex justify-content-end">
                        <div class="p-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $label)): ?>
                                <form method="POST" class="d-inline" action="<?php echo e(route('labels.destroy', $label)); ?>">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="row d-flex justify-content-between mt-4">
            ...
            <div class="col-3 d-flex align-self-center justify-content-end">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Label::class)): ?>
                    <a href="<?php echo e(route('labels.create')); ?>" class="btn-primary">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hexlet-stub-test','data' => ['objects' => $labels]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.title-task-manager','data' => ['text' => 'messages.Label']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/segodnya/Desktop/hexlet/php-project-57/resources/views/label/index.blade.php ENDPATH**/ ?>